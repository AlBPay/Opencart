<?php
// Heading
$_['heading_title']      = 'Alliance bank (Visa/MasterCard)';

// Text 
$_['text_payment']       = 'Оплата';
$_['text_oplata']        = '<a onclick="window.open(\'https://fondy.ru/\');"><img src="view/image/payment/oplata.png" alt="Alliance bank" title="Alliance bank" style="border: 1px solid #EEEEEE;" /></a>';
